"""
Script para enviar imagem 64x64 RGB para ESP32-S3 via USB
"""
import serial
import numpy as np
import struct
...
def create_test_image():
    """Cria uma imagem de teste 64x64x3"""
...
def send_image(port, baudrate, image):
    ...
    try:
        ...
        header = struct.pack('<HHB', 64, 64, 3)  # width, height, channels
        ser.write(header)
...
# --- BLOCO NOVO: Leitura Inteligente ---
        ...
        while (time.time() - start_time) < 5:  # Tenta ler por até 5 segundos
...
def load_image(image_path):
    """Carrega e redimensiona imagem para 64x64"""
    try:
        ...
        # Redimensiona para 64x64 e converte para RGB
...
def main():
    parser = argparse.ArgumentParser(
        description='Envia imagem 64x64 para ESP32-S3',
